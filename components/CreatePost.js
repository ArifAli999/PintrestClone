                        ...
                        <div class="flex  p-6 flex-col items-center gap-4 justify-between  ">
                            ...
                            <div class="w-full rounded-lg ">
                                <label className='text-xs text-gray-500 w-full mb-4'>FILE
                                    <div class="mt-2 rounded border border-gray-300 ">

                                        <div class="flex items-center justify-center w-full ">

                                            <label
                                                class="flex flex-col w-full h-full mt-6 justify-center">

                                                <div class="flex flex-col items-center justify-center pt-0 mb-4 w-full">
                                                    {img ? (<img src={img} alt="" className="w-full max-h-60 object-contain " />) : (<>
                                                        <svg xmlns="http://www.w3.org/2000/svg" class="w-8 h-8 text-pink-400 group-hover:text-pink-50"
                                                            fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                                                d="M7 16a4 4 0 01-.88-7.903A5 5 0 1115.9 6L16 6a5 5 0 011 9.9M15 13l-3-3m0 0l-3 3m3-3v12" />
                                                        </svg>
                                                        <p class="pt-4 text-sm tracking-wider text-gray-400 group-hover:text-gray-600">
                                                            Attach an image
                                                        </p></>)}


                                                </div>
                                                <input type="file" class="opacity-0 bg-gray-400" onChange={handleChange} accept="/image/*" />
